    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav" id="nav_search">
                <li><a href="/main/contacts"><span class="glyphicon glyphicon-send"></span> feedback</a></li>
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <?php } else { ?>
                    <li class="dropdown">
                        <a href="/main/login" class="navbar-link"><span class="glyphicon glyphicon-log-out"></span> login</a>
                    </li>
                <?php } ?>
            </ul>
        </div><!-- /.navbar-collapse -->
